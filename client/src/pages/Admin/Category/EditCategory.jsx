                                            ...
                                            <form className="mt-2 w-full" onSubmit={HandleSubmit}>
                                                {
                                                    ...
                                                    Data?.image && (
                                                        <div>
                                                            <img className='rounded-2xl bg-gray-200 mb-3' src={`${ApiURL}/image/200/${Data?.image}`} alt="" />
                                                        </div>
                                                    )
                                                }
                                                {/* IMAGE  */}
                                                <div className="flex flex-col gap-4 items-center justify-center w-full h-full">
                                                        ...
                                                        image?.file && (
                                                            <div className='flex justify-center flex-wrap gap-4'>
                                                                <div className="w-[120px] bg-gray-200 rounded-xl p-2" >
                                                                    ...
                                                                    <button type='button' className='text-center bg-red-200 text-red-500 w-full py-1 mt-2 rounded-lg'
                                                    ...
                                                    <label htmlFor="dropzone-file" className="flex flex-col items-center text-center justify-center w-full h-full p-4 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-100">
                                                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                                            ...
                                                            <p className='text-sm text-gray-500 font-medium mb-2'>Update new image</p>
                                                ...
                                                <div className='mt-4 grid gap-4'>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <input type="text" maxLength={100}
                                                            ...
                                                            value={category || Data?.name} onChange={(e) => setCategory(e.target.value)}
